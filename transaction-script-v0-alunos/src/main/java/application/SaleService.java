...
import business.ProductToSaleTransactionScript;
import business.SaleTransactionScript;
...
public enum SaleService {
	...
	private SaleTransactionScript saleTS;
	private ProductToSaleTransactionScript salePSTS;
	//private SaleTransactionScript saleTS;

	private SaleService(){
		saleTS = new SaleTransactionScript();
		salePSTS = new ProductToSaleTransactionScript();
	};
	...
	public void addProductToSale(int saleId, int productCode, int qty) 
		...
		salePSTS.addProductToSale(saleId,productCode,qty);
	}
