...
public class SaleRowDataGateway {
	...
	private static final String INSERT_SALE_SQL = 
			"insert into sale(date,status,total,discount_total,customer_id,vendedor_id) values (?,?,?,?,?,?)"; // TODO: program me!
	...
	public static void update(int saleId,int vendedorId) throws PersistenceException{
